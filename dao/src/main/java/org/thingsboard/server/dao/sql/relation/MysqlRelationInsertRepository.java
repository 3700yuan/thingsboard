...
@Repository
@Transactional
public class MysqlRelationInsertRepository extends AbstractRelationInsertRepository implements RelationInsertRepository {
    ...
    */
    private static final String INSERT_ON_CONFLICT_DO_UPDATE = "insert into relation(from_id, from_type, to_id, to_type, relation_type_group, relation_type, additional_info) " +
           "VALUES (:fromId, :fromType, :toId, :toType, :relationTypeGroup, :relationType, :additionalInfo) on duplicate key update from_id=:fromId,from_type=:fromType,relation_type_group=:relationTypeGroup,relation_type=:relationType,to_id=:toId,to_type=:toType";
