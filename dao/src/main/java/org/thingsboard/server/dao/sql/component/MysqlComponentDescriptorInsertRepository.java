...
public class MysqlComponentDescriptorInsertRepository extends AbstractComponentDescriptorInsertRepository {
    ...
    private static final String P_KEY_CONFLICT_STATEMENT = "component_descriptor.id=:id";
    private static final String UNQ_KEY_CONFLICT_STATEMENT = "component_descriptor.clazz=:clazz";
    ...
    private static String getInsertString(String conflictStatement) {
        ...
        String sql = "insert into component_descriptor(id, actions, clazz, configuration_descriptor, name, scope, search_text, type) VALUES (:id, :actions, :clazz, :configuration_descriptor, :name, :scope, :search_text, :type) on duplicate key update "+ conflictStatement;
        log.info("sql = " + sql);
        return sql;
    }
}
